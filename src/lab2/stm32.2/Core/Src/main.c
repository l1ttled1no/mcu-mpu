...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LED_Pin|ENM0_Pin|ENM1_Pin|ENM2_Pin
  ...
  /*Configure GPIO pins : LED_Pin ENM0_Pin ENM1_Pin ENM2_Pin
                           ENM3_Pin ENM4_Pin ENM5_Pin ENM6_Pin
                           ENM7_Pin */
  GPIO_InitStruct.Pin = LED_Pin|ENM0_Pin|ENM1_Pin|ENM2_Pin
                          |ENM3_Pin|ENM4_Pin|ENM5_Pin|ENM6_Pin
                          |ENM7_Pin;
